...
if (!$conexion){
	...
	$statement = $conexion->prepare('SELECT * FROM voluntario WHERE cd LIKE :cd');
      ...
      <div id="container-body">
	<div class="alert alert-warning">
  		<strong>Error</strong> Cédula ya registrada, contactese con el adminitrador en el siguiente link: <h4><strong><a href="contact.php">Contacto</a></strong></h4>
			</div>' 
			</div>
	<?php	
		}else{
  ...
  <strong>Exito!</strong> Usted a sido registrado con exito como voluntario de nuestra organización.
</div>' 
</div>
<?php
}
...
<?php
include ("views/volunteer.view.php");
